...
if (!empty($_POST)) {
    ...
    $query        = " SELECT 1 FROM attivita WHERE username = :user";
    ...
    if ($row) {
        ...
        $response["success"] = 0;
        $response["message"] = "Mi dispiace, questo username è già in uso";
        die(json_encode($response));
    }
    ...
    $query = "INSERT INTO attivita ( username, password ) VALUES ( :user, :pass ) ";
    ...
    $response["success"] = 1;
    $response["message"] = "Account registrato con successo!";
